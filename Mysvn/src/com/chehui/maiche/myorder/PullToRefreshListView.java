...
public class PullToRefreshListView extends ListView {
	 ...
	 */
	public void setLockScrollWhileRefreshing(
			boolean lockScrollWhileRefreshing) {
	 ...
	 */
	public void setLastUpdatedDateFormat(
			SimpleDateFormat lastUpdatedDateFormat) {
	...
	private void init() {
		...
		releaseToRefreshText = getContext()
	...
	private void setHeaderPadding(int padding) {
		...
		MarginLayoutParams mlp = (ViewGroup.MarginLayoutParams) header
				.getLayoutParams();
		mlp.setMargins(0, Math.round(headerPadding), 0, 0);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			if (previousY != -1 && (state == State.RELEASE_TO_REFRESH
	...
	private void bounceBackHeader() {
		...
		int yTranslate = state == State.REFRESHING
				...
				: -headerContainer.getTop() - headerContainer.getTop()
						+ getPaddingTop();
		...
		bounceAnimation.setInterpolator(
				new OvershootInterpolator(BOUNCE_OVERSHOOT_TENSION));
		bounceAnimation
				.setAnimationListener(new HeaderAnimationListener(yTranslate));
	...
	private class PTROnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> adapterView, View view,
			...
			if (onItemClickListener != null && state == State.PULL_TO_REFRESH) {
				...
				// header views
				onItemClickListener.onItemClick(adapterView, view,
