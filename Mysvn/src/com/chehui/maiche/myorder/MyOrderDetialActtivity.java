...
public class MyOrderDetialActtivity extends BaseActivity {
	...
	private void modifyPrice() {
		...
		postFloorPrice = post_floorPrice.getText().toString().trim().equals("待定")?"":post_floorPrice.getText().toString().trim();
		postInsurance = post_insurance.getText().toString().trim().equals("待定")?"":post_insurance.getText().toString().trim();
		postLicensePrice = post_licensePrice.getText().toString().trim().equals("待定")?"":post_licensePrice.getText().toString().trim();
		...
		System.out.println("modifyPrice cutCarPlan="+cutCarPlan);
		postTax = post_tax.getText().toString().trim().equals("待定")?"":post_tax.getText().toString().trim();

		postOtherFee = post_otherFee.getText().toString().trim().equals("待定")?"":post_otherFee.getText().toString().trim();

		postExtralGift = post_extralGift.getText().toString().trim().equals("待定")?"":post_extralGift.getText().toString().trim();
		...
		System.out.println("updataParams===="+updataParams);
	...
	private void updataQuote() {
		// FrameLayout updataForm = (FrameLayout) getLayoutInflater().inflate(
		// R.layout.acitivty_myorderdetial_updata_layout, null);
		...
		Log.d("修改报价查看数据", guideprice + insurancePrice + licensePrice +carPlan);
	...
	private void updataOrder(final String updataParams) {
		...
		new AsyncTask<Void, Integer, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				System.out.println(updataParams);
	...
	private void initWidget() {
		...
		String floorPrice = String.valueOf(floorPriceCN_txt);
...
//		txt_carPlan.setText(map.get("carPlan"));
		System.out.println("modify carPlan="+map.get("carPlan"));
