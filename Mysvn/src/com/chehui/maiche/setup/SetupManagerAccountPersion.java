...
public class SetupManagerAccountPersion extends BaseActivity implements
	...
	private String txt_brand_modifyed = "一汽大众";
	...
	protected void onStart() {
		...
		Log.d(TAG + "个人信息的调试", mCityName + mSellerBrandName);
	...
	protected void onPause() {
		...
		if (CommonData.MODIFYFLAG != false) {
			...
			System.out.println("params======" + conParams);

			// 修改完成初始化标量值
			CommonData.MODIFYFLAG = false;
