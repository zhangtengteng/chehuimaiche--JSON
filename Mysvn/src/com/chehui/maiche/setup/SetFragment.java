...
public class SetFragment extends BaseFragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		layout = inflater.inflate(R.layout.setup_fragment_layout, container,
				false);
		initWidgets();
		return layout;
	}
	...
	private void initWidgets() {
		...
		mAuthen = (RelativeLayout) layout
				.findViewById(R.id.setup_authen_layout);
		mPushMsg = (RelativeLayout) layout
				.findViewById(R.id.setup_pushmsg_layout);
