...
public class RabateSelectCardActivity extends BaseActivity
{
	...
	/** 卡号对应tel */
//	private HashMap<String, String> cardForTelMap = new HashMap<String, String>();
	...
	private void setListener()
	{
		...
		sp_bankName.setOnItemSelectedListener(new OnItemSelectedListener()
		{
			...
			public void onItemSelected(AdapterView<?> parent, View view,
					int position, long id)
			{
//				 int selectedItemPosition = sp_name.getSelectedItemPosition();
//				 name = infoList.get(selectedItemPosition);
	...
	private void initView()
	{
		...
		btn_next.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent i = new Intent(RabateSelectCardActivity.this,RabateVertifyActivity.class);
	...
	{
		 sellerId =
		 SharedPreManager.getInstance().getInt(CommonData.USER_ID, 103);
	...
	private void analysisJson()
	{
		try
		{
			...
			if(jsonArray.equals("")){
				ToastUtils.showShortToast(RabateSelectCardActivity.this, "请添加银行卡");
			}
	...
	private String checkTel()
	{
		...
		{
			PersonInfo info = personinfoDataList.get(i);
			if(info.getBankName().equals(bankName) && info.getCardAdmin().equals(name)
