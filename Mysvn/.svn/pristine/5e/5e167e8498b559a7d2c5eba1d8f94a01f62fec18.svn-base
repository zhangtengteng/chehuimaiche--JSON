...
*/
	...
	/** 初始化组件 */
	@SuppressLint("CutPasteId") private void initWidgets() {
	...
	private void register() {
		...
		RegisterManager.getInstance().setPassWord(checkpassword);
		  ...
		  postParams = username + "|" + password + "|" + phoneNum + "|"
				+ mail + "|" + converterToSpell(cityname);
		  Intent intent = new Intent(RegSellerRegisterActivity.this,RegSelectBrandActivity.class);
